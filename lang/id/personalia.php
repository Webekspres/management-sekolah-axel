...
return [
    'import' => [
        ...
        'preview' => [
            ...
            'rows' => ':count baris data siap diimpor.',
            'level_missing' => 'Pilih tingkat sekolah (SD/SMP/SMA) di bagian atas halaman sebelum mengunggah.',
            'unmapped_columns' => 'Kolom wajib belum dipetakan: :columns.',
            'ready' => 'File siap diunggah. Klik Unggah Data untuk memulai.',
        ],
        'progress' => [
            'total' => 'Total',
            'successful' => ':count baris berhasil',
            'successful_label' => 'Berhasil',
            'failed' => ':count baris gagal',
            'failed_label' => 'Gagal',
        ],
        'notifications' => [
            'processing_title' => 'Sedang mengimpor data...',
