...
return [
    ...
    'payment_settings' => [
        'action_label' => 'Pengaturan rekening',
        'heading' => 'Rekening & kontak pembayaran',
        'description' => 'Data ini ditampilkan ke siswa saat memilih transfer bank. Nomor WhatsApp sekolah hanya untuk referensi admin.',
        'section' => 'Informasi rekening',
        'section_hint' => 'Pastikan nomor rekening dan nama pemilik sesuai dengan rekening sekolah yang aktif.',
        'bank_name' => 'Nama bank',
        'account_number' => 'Nomor rekening',
        'account_holder' => 'Atas nama',
        'school_whatsapp' => 'Nomor WhatsApp sekolah',
        'submit' => 'Simpan',
        'cancel' => 'Batal',
        'saved' => 'Pengaturan rekening berhasil disimpan.',
    ],
    'default_spp' => [
